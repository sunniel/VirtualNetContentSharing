...
#ifndef CTRL_BASICCLIENTSORTEDDELAYTEST_H_
#define CTRL_BASICCLIENTSORTEDDELAYTEST_H_
...
class BasicClientSortedDelayTest: public HostBase {
private:
    unsigned long id;
    Coordinate location;
    Coordinate origin;
    ...
    multimap<long, string> toDownloads;
...
public:
    BasicClientSortedDelayTest();
    virtual ~BasicClientSortedDelayTest();
};
