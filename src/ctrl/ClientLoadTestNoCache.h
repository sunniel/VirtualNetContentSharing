...
#ifndef CLIENTLOADTESTNOCACHE_H_
#define CLIENTLOADTESTNOCACHE_H_
...
class ClientLoadTestNoCache: public HostBase {
private:
    unsigned long id;
    Coordinate location;
    Coordinate origin;
...
public:
    ClientLoadTestNoCache();
    virtual ~ClientLoadTestNoCache();
};
